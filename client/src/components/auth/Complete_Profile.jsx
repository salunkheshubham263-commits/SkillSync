...
const Complete_Profile = ({ setActiveForm }) => {
    ...
    useEffect(() => {
        const fetchSkills = async () => {
            try {
                const response = await axios.get("http://192.168.0.118:5000/api/profile/skills");
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.post("http://192.168.0.118:5000/api/profile/complete-profile", formData, {
                headers: {
